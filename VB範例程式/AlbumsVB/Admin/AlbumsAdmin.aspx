<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AlbumsAdmin.aspx.vb" Inherits="Admin_AlbumsAdmin" %>
        ...
        <div id="content">
            ...
            <asp:View ID="View1" runat="server">
                ...
                <asp:GridView ID="gvAlbums" runat="server" AllowPaging="True" 
                    ...
                    EmptyDataText="沒有資料錄可顯示。" Font-Size="10pt" ForeColor="Black" Width="700px">
                    <RowStyle Wrap="True" />
                    <Columns>
                ...
                <table ID="detail">
                    ...
                    <tr>
                        <td class="tblFooter" class="column1" colspan="2">
                            <asp:Button ID="btnInsertDetail" runat="server" 
