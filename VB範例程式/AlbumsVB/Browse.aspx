<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Browse.aspx.vb" Inherits="Browse" %>
        ...
        <div id="header">
            ...
            <div id="navigation">        
                <div id="nav-home">
                    ...
                    <asp:ImageButton ID="btnPhotos" runat="server" 
                        ImageUrl="~/Images/iconAlbum.png" ToolTip="回上一層相簿" />
                </div>
                <!--Button按鈕-->
                <div id="navi-button">
                    <asp:ImageButton ID="btnFirst" runat="server" AlternateText="第一張" 
                        ImageUrl="~/Images/btnFirst.png" />
                    <asp:ImageButton ID="btnPrevious" runat="server" AlternateText="前一張" 
                        ImageUrl="Images/btnPrevious.png" />
