        ...
        <div id="content">
            <div id="loginStyle">
                ...
                <div id="pwdStyle">
                    ...
                    <asp:ImageButton ID="btnPassword" runat="server" ImageUrl="~/Images/Password.png" />
                    <asp:SqlDataSource ID="sqlAlbumPwd" runat="server" ConnectionString="<%$ ConnectionStrings:AlbumDBConnectionString1 %>"
                        ...
                        <SelectParameters>
                            ...
                            <asp:ControlParameter ControlID="txtPassword" Name="paramPwd" PropertyName="Text" />
                        </SelectParameters>
                    </asp:SqlDataSource>
                    <br />
