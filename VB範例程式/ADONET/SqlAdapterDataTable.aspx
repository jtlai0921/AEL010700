<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SqlAdapterDataTable.aspx.vb"
    Inherits="SqlAdapterDataTable" %>
...
<body>
    ...
    <div>
        ...
        <br />
        <asp:Button ID="btnFill" runat="server" Text="將資料Fill到DataTable" />
        <br />
        <br />
