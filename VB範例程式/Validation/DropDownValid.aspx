<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DropDownValid.aspx.vb" Inherits="DropDownValid" %>
...
<body>
    ...
    <div>
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtName"
            ErrorMessage="*姓名不可為空白" ForeColor="Red"></asp:RequiredFieldValidator>
        <br />
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="dwnCity"
            ErrorMessage="*請選擇您所居住的縣市" InitialValue="請選擇居住縣市" ForeColor="Red"></asp:RequiredFieldValidator>
        <br />
        <br />
        <asp:Button ID="btnSumbit" runat="server" OnClick="btnSumbit_Click" Text="確定" Width="80px" />
        <br />
        <br />
