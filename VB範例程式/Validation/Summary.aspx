...
<body>
    ...
    <div>
        <h2>
            ValidationSummary控制項</h2>
        姓 名：
        <asp:TextBox ID="txtName" runat="server"></asp:TextBox>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtName"
            ErrorMessage="*姓名不得為空白" ForeColor="Red">*必要輸入</asp:RequiredFieldValidator>
        <br />
        <br />
        ...
        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtMail"
            Display="Dynamic" ErrorMessage="*電子郵件格式錯誤" 
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtMail"
            ErrorMessage="*電子郵件輸入不得為空白" ForeColor="Red">*必要輸入</asp:RequiredFieldValidator>
        <br />
        <br />
        地 址：
        <asp:TextBox ID="txtAddress" runat="server" Width="440px"></asp:TextBox>
        <asp:CustomValidator ID="CustomValidator1" runat="server" ControlToValidate="txtAddress"
            ErrorMessage="*地址不得為空白，且必須包含門牌號碼" ClientValidationFunction="checkAddress" 
            ValidateEmptyText="True" ForeColor="Red">*格式錯誤</asp:CustomValidator>
        <br />
        <br />
