<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RequiredFieldBasic.aspx.vb"
...
<body>
    ...
    <div>
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtTel"
            ErrorMessage="*電話不可為空白" ForeColor="Red"></asp:RequiredFieldValidator>
        <br />
        <br />
        <asp:Button ID="btnSumbit" runat="server" Text="確定" Width="100px" />
        <br />
        <br />
