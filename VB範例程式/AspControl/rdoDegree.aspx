<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rdoDegree.aspx.vb" Inherits="rdoDegree" %>
...
<body>
    ...
    <div>
        ...
        <br />
        <asp:RadioButton ID="rdoUniversity" runat="server" GroupName="Degree" Text="大學/專科" />
        <br />
        ...
        <br />
        <asp:Button ID="btnSumbit" runat="server" OnClick="btnSumbit_Click" Text="確定" Width="100px" />
        <br />
        <br />
