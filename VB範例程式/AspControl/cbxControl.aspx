<%@ Page Language="VB" AutoEventWireup="false" CodeFile="cbxControl.aspx.vb" Inherits="cbxControl" %>
...
<body>
    ...
    <div>
        <asp:Image ID="Image1" runat="server" Height="60px" ImageUrl="~/Images/Habits.jpg"
            Width="450px" />
        <br />
        請選擇您的興趣：
        <asp:CheckBoxList ID="cbxHabits" runat="server" RepeatColumns="2" Width="450px" BackColor="#99FF99"
