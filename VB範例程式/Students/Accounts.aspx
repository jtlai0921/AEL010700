<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false"
    CodeFile="Accounts.aspx.vb" Inherits="Accounts" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:GridView ID="gvAccount" runat="server" AllowPaging="True" AllowSorting="True"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="角色群組" SortExpression="Role">
                <EditItemTemplate>
                    <asp:DropDownList ID="dwnRole" runat="server" OnSelectedIndexChanged="dwmRole_SelectedIndexChanged"
                        ToolTip='<%# Bind("Role") %>'>
    ...
    <asp:Panel ID="plAccount" runat="server">
        ...
        <div id="NewAccount">
            ...
            ＊群組：<asp:DropDownList ID="dwnRole" runat="server" OnSelectedIndexChanged="dwmRole_SelectedIndexChanged"
                ToolTip='<%# Bind("Role") %>'>
                <asp:ListItem Value="0">==請選擇==</asp:ListItem>
                <asp:ListItem Value="1">Admin</asp:ListItem>
                <asp:ListItem Value="2">Operator</asp:ListItem>
            ...
            <br />
            <asp:Button ID="btnNew" runat="server" Text="新增帳號" />
            <br />
