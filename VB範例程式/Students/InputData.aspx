<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false"
    CodeFile="InputData.aspx.vb" Inherits="InputData" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:DetailsView ID="dvStudent" runat="server" AutoGenerateRows="False" CellPadding="4"
        ...
        Width="740px" ClientIDMode="Static" DefaultMode="Insert" Font-Size="10pt" HeaderText="&lt;div align='center'&gt;學生基本資料新增&lt;/div&gt;">
        ...
        <Fields>
            ...
            <asp:TemplateField HeaderText="身高" SortExpression="Height">
                <InsertItemTemplate>
                    <asp:DropDownList ID="dwnHeight" runat="server" OnSelectedIndexChanged="dwnCity_SelectedIndexChanged"
                        ToolTip='<%# Bind("Height") %>'>
                    </asp:DropDownList>
                    &nbsp;cm
                </InsertItemTemplate>
            ...
            <asp:TemplateField HeaderText="縣市" SortExpression="City">
                <InsertItemTemplate>
                    <asp:DropDownList ID="dwnCity" runat="server" DataSourceID="XmlDataSource1" Height="18px"
                        ...
                        ToolTip="<%# Bind('City') %>" OnSelectedIndexChanged="dwnCity_SelectedIndexChanged">
