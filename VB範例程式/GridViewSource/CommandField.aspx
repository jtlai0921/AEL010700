<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CommandField.aspx.vb" Inherits="CommandField" %>
    ...
    <h2>CommandField命令按鈕欄位的應用</h2>
        <asp:GridView ID="gvProducts" runat="server" AutoGenerateColumns="False" BackColor="White"
            ...
            <Columns>
                ...
                <asp:CommandField ButtonType="Button" ShowEditButton="True" HeaderText="編輯">
                    <ControlStyle BackColor="#CC99FF" />
                </asp:CommandField>
                <asp:CommandField ButtonType="Button" ShowDeleteButton="True" HeaderText="刪除">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:NorthwindConnectionString1 %>"
            DeleteCommand="DELETE FROM [Products] WHERE [ProductID] = @ProductID" InsertCommand="INSERT INTO [Products] ([ProductName], [UnitPrice]) VALUES (@ProductName, @UnitPrice)"
