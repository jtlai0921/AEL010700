<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DragAndDropDB.aspx.vb" Inherits="DragAndDropDB" %>
...
<body>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:NorthwindConnectionString1 %>"
            DeleteCommand="DELETE FROM [Employees] WHERE [EmployeeID] = @EmployeeID" InsertCommand="INSERT INTO [Employees] ([LastName], [FirstName], [Address]) VALUES (@LastName, @FirstName, @Address)"
