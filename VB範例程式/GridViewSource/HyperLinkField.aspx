<%@ Page Language="VB" AutoEventWireup="false" CodeFile="HyperLinkField.aspx.vb"
    Inherits="HyperLinkField" %>
    ...
    <h2>HyperLinkField超連結欄位的應用</h2>
        <asp:GridView ID="gvProducts" runat="server" AutoGenerateColumns="False" CellPadding="4"
            ...
            <Columns>
                ...
                <asp:HyperLinkField DataNavigateUrlFields="ProductName,CategoryID,SupplierID" DataNavigateUrlFormatString="ProductDetails.aspx?ProductName={0}&amp;CategoryID={1}&amp;SupplierID={2}"
