<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ExtractTemplateRow.aspx.vb"
...
<body>
    ...
    <div>
        <h2>DataList控制項的ExtractTemplateRows屬性應用</h2>
        <asp:DataList ID="dlProducts" runat="server" DataKeyField="ProductID" DataSourceID="SqlDataSource1"
            CellPadding="4" ForeColor="#333333" Width="350px" 
            Height="110px">
            <ItemTemplate>
                <asp:Table ID="Table1" runat="server" Width="100%">
                    <asp:TableRow >
                        <asp:TableHeaderCell Text='<%# String.Format("<<< {0} >>>",Eval("ProductID")) %>' BackColor="#FFCCCC" ></asp:TableHeaderCell>
                    </asp:TableRow>
                    <asp:TableRow>
