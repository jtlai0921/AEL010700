<%@ Page Language="VB" AutoEventWireup="false" CodeFile="fvCommandButton.aspx.vb"
...
<body>
    ...
    <div>
        <asp:FormView ID="fvEmp" runat="server" AllowPaging="True" DataKeyNames="EmployeeID"
            DataSourceID="sqldsEmployees" BackColor="LightGoldenrodYellow"
            BorderColor="Tan" BorderWidth="1px" CellPadding="2" FooterText="限人事單位使用" ForeColor="Black"
            GridLines="Both" HeaderText="員工基本資料表" Width="184px" Font-Size="10pt">
            <EditItemTemplate>
                EmployeeID:
                ...
                <table style="width: 400px">
                    <tr>
                        <td style="width: 350px">
                            ...
                            <asp:Button ID="btnEdit" runat="server" CommandName="Edit" Text="編輯" OnClick="btnEdit_Click" />
                        </td>
                        <td style="width: 100px">
                            <img src='ImageHandler.ashx?EmployeeID=<%# Eval("EmployeeID") %>' alt="" />
                        </td>
                    </tr>
                </table>
            </ItemTemplate>
